...
print("{:20}{:20}{:20}".format("MAC ADDRESS", "IP ADDRESS", "INTERFACE"))
for output in processed_list:
    print("{:20}{:20}{:20}".format(output["mac_addr"], output["ip_addr"], output["interface"]))
print()
